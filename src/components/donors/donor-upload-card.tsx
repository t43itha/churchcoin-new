...
export function DonorUploadCard({ onFileParsed }: DonorUploadCardProps) {
  ...
  return (
    <Card className="border-ledger bg-paper shadow-none">
      <CardHeader>
        <CardTitle className="text-ink">Upload donor list</CardTitle>
        <CardDescription className="text-grey-mid">
          Import donors in bulk from CSV. We&apos;ll help you map columns and detect duplicates.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {error ? (
          ...
          <p className="text-xs text-grey-mid">
            Expected columns: Name (required), Email, Phone, Address, Bank Reference, Gift Aid Signed, Gift Aid Date, Notes
          </p>
        )}
      </CardContent>
    </Card>
